                    ...
                    <tr>
                        <td>
                            <h2 class="table-avatar">
                                <a href="doctor-profile" class="avatar avatar-sm mr-2 float-left">
                                    <img class="avatar-img rounded-circle" src="{{asset($appointment->clinic->doctor->user->image)}}" alt="User Image">
                                </a>
                                <a href="doctor-profile">{{$appointment->clinic->doctor->user->name}} <span>{{$appointment->clinic->doctor->speciality->name}}</span></a>
                            </h2>
                        </td>
